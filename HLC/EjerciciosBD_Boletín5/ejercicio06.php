...
<body>
 ...
 <p>Escribe el oficio:
 <input name="oficio" type="text" size="10"/>
 </p>
...
function comprobarInputs(){
    if ($_POST['dept_num']==''||$_POST['oficio']=='') {
...
emple where dept_no='$dept_num' and oficio='$oficio'");
...
echo '<h2> No hay consultas disponibles</h2>';
    ...
    echo '<hr>
    <h2>LISTADO DE LOS EMPLEADOS DEL DEPARTAMENTO DE  '. strtoupper(mysqli_fetch_array ($resultado2)['dnombre']).' Y OFICIO '.strtoupper($oficio).'</h2>
    <table>
    <tr> 
    <th>Empleado</th>
    <th>Apellido</th>
